class SimulationConfig:
    ...
    STOP_VIRTUAL_TIME = 500.0 # Stop simulation after 500 virtual-time seconds
    ...
    TRAFFIC_INTENSITIES = {"high": 0.045, "medium": 0.03, "low": 0.015} # Chance of spawning a vehicle per frame per road
